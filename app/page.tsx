...
export default async function Home(){
  ...
  return <ProductShell><main className="product-page home-page">
    <section className="product-hero"><div><span className="hero-kicker">上海学区决策助手 · 2026</span><h1>上海学区选择决策助手</h1><p>把学校 → 升学路径 → 学区房 → 信息源放在一起，帮你盘清楚</p></div><div className="hero-data-card"><span>当前产品数据</span><b>{o.schools.toLocaleString()}<small> 所学校</small></b><div><span>{o.communities.toLocaleString()} 小区</span><span>{o.assignments.toLocaleString()} 关系</span><span>{o.policies.toLocaleString()} 条信息源</span></div></div></section>
